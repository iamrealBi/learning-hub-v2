...
```csharp title="C#"
// test:compile
public static class ShippingFeeCalculatorV1
{
...
```csharp title="C#"
// test:compile
public static class ShippingFeeCalculatorV2
{
...
**Tiếp theo →** [P6 · Design Patterns nâng cao](design-patterns-nang-cao.md)
